...
def test_project_creation():
    ...
    with fastapi.testclient.TestClient(serve.app) as client:
        ...
        client.post(
            f"/api/v1/projects/{project_y.id}/images/1/labels", data=labels_1y.json()
        ).json()
        ...
        client.post(
            f"/api/v1/projects/{project_y.id}/images/2/labels", data=labels_2y.json()
        )
        labels_2z = web.ImageLabels.parse_obj(
            client.get(f"/api/v1/projects/{project_y.id}/images/2/labels").json()
        )
